                            ...
                            <div className="accordion-body">
                                {['Табачный вкус', 'Фруктовый вкус', 'Ментол', 'Экзотические'].map((flavor) => (
                                    <label key={flavor}>
                                        <input
                                            type="checkbox"
                                            checked={localFilters.flavors.includes(flavor)}
                                            onChange={() =>
                                                updateLocalFilter(
                                                    'flavors',
                        ...
                        <div className="accordion-body">
                            {['Terea', 'Heets', 'Delia'].map((brend) => (
                                <label key={brend}>
                                    <input
                                        type="checkbox"
                                        checked={localFilters.brend.includes(brend)} 
                                        onChange={() =>
                                            updateLocalFilter(
                                                'brend', 
                            ...
                            <div className="accordion-body">
                                {['Легкие', 'Средние', 'Крепкие'].map((strength) => (
                                    <label key={strength}>
                                        <input
                                            type="checkbox"
                                            checked={localFilters.strengths.includes(strength)}
                                            onChange={() =>
                                                updateLocalFilter(
                                                    'strengths',
                                                    localFilters.strengths.includes(strength)
                                                        ? localFilters.strengths.filter((s) => s !== strength)
