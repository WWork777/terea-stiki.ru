...
export async function POST(req) {
  try {
    ...
    let subject = "Заявка с сайта TelegramBot";
    ...
    if (text.includes("НОВЫЙ КЛИЕНТ") || text.includes("🔥 НОВЫЙ КЛИЕНТ 🔥")) {
      subject = `🔥 НОВЫЙ КЛИЕНТ: ${customerName} - TelegramBot`;
    } else {
      subject = `Заявка от ${customerName} - TelegramBot`;
    }
        ...
        <body>
          <div class="email-container">
            <div class="email-header">
              <h2>Заявка с сайта TelegramBot</h2>
            </div>
            ...
            <div class="email-content">
              ...
              <div class="footer">
                <p>Отправлено с сайта TelegramBot</p>
    ...
    const mailOptions = {
      ...
      headers: {
        ...
        "X-Mailer": "TelegramBot Contact Form",
      },
    };
